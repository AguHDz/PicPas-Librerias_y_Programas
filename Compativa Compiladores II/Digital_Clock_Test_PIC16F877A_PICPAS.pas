...
begin
  // En PicPas v0.8.0 no es válida la expresión DS1307_XXX := BCDToDecimal(I2C_readByte(true));
  // por ello es necesario realizar la misma operación en 2 pasos.
  ...
  DS1307_Segundo   := I2C_readByte(true);  // ASK = 1
  DS1307_Minuto    := I2C_readByte(true);
  DS1307_Hora      := I2C_readByte(true);
  DS1307_DiaSemana := I2C_readByte(true);
  DS1307_Dia       := I2C_readByte(true);
  DS1307_Mes       := I2C_readByte(true);
  DS1307_Ano       := I2C_readByte(false); // ASK = 0
...
var
  aux : byte;
begin
  // En PicPas v0.8.0 no es válida la expresión I2C_writeByte(decimalToBCD(DS1307_XXX));
  // por ello es necesario realizar la misma operación en 2 pasos usando una variable auxiliar.
  I2C_start;           // Inicia comunicación I2C
  I2C_writeByte($D0);  // Dirección I2C del DS1307.
  I2C_writeByte($00);  // Primera dirección a leer/escribir. 
