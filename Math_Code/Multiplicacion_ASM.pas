...
//  Por ahora PicPas (v.0.6.8) no permite el uso de funciones.
//***********************************************************************
procedure Multiplicar (multiplicando, multiplicador : byte);
begin
ASM
;Inicializacion de Registros
  BCF STATUS,STATUS_RP0     ; RP0=0 / Trabajamos en el Banco de memoria 0.
...
MULT_LOOP:
  ...
  BTFSC STATUS,STATUS_C     ; Comprueba el bit CARRY del registro STATUS.
