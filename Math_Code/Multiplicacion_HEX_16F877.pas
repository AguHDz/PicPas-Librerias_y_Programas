...
var
  resultado : word; // Variable global con resultado de multiplicacion que se mostrara en el display.
...
begin
  ASM
    ;----Inicializacion de Registros
      BCF     STATUS_RP0          ; Trabajamos en el Banco de memoria 0.
