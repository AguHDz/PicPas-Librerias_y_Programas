...
*  (solo 2 hilos de comunicacion), y una velocidad de 9600 bits por segundo.
*
...
unit UARTSoftLib_16MHz_9600bps;
...
// Delay = 0.00005208333 seconds (1/Baudrate/2).
// -----------------------------------------------------------------
procedure MedioBitDelay;
const
// -----------------------------------------------------------------
// Clock frequency = 20 MHz    
// Actual delay = 0.00005208333 seconds = 256 cycles
// Error = 0.15999361024 %
// CICLOS_DELAY_1 = $55;
// -----------------------------------------------------------------
// Clock frequency = 16 MHz    
// Actual delay = 0.00005208333 seconds = 208 cycles
// Error = 0.15999361024 %
   CICLOS_DELAY_1 = $43;
// -----------------------------------------------------------------
// Clock frequency = 12 MHz    
// Actual delay = 0.00005208333 seconds = 151 cycles
// Error = 0 %
//   CICLOS_DELAY_1 = $32;
// -----------------------------------------------------------------
// Clock frequency = 10 MHz    
// Actual delay = 0.00005208333 seconds = 130 cycles
// Error = 0.15999361024 %
//   CICLOS_DELAY_1 = $29;
// -----------------------------------------------------------------
// Clock frequency = 8 MHz    
// Actual delay = 0.00005208333 seconds = 104 cycles
// Error = 0.15999361024 %
//   CICLOS_DELAY_1 = $21;  // (NO RECOMENDABLE)
// -----------------------------------------------------------------
// Clock frequency = 4 MHz    
// Actual delay = 0.00005208333 seconds = 52 cycles
// Error = 0.15999361024 %
//   CICLOS_DELAY_1 = $0F;  //  (NO USAR - ERRORES COMUNICACION)
// -----------------------------------------------------------------
...
begin
  ASM   
            ...
            ; 151 cycles -> 12 MHz
            ; 130 cycles -> 10 MHz
            ; 106 cycles ->  8 MHz  ; (NO RECOMENDABLE)
            ;  46 cyckes ->  4 MHz  ; (NO USAR - ERRORES COMUNICACION)
...
procedure BitDelay;
begin
  MedioBitDelay;  // 0.0000523 seconds
  MedioBitDelay;  // 0.0000523 seconds
end;
