...
*  para el manejo de números largos de 2 bytes (valores de 0 a 65.535)
*
...
begin
  Math_16bits_MODULO;  // Es procedimiento devuelve el cociente en SYS_MATH_NUM_A.   
...
procedure Math_16bits_DEVUELVE_ACUMULADOR;
begin
...
// Demostración de uso de operaciones con variables de 32 bits
  ...
  Math_16bits_CARGA_B;
  Math_16bits_SUMAR;
  Math_16bits_DEVUELVE_ACUMULADOR;
  LCD_GotoXY(3,6);
  LCD_WriteChar('=');
  Math_16bits_Print_ACUMULADOR;
